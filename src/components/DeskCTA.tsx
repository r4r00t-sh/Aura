import { CHARTER_PHONE_TEL, CHARTER_WHATSAPP } from "../data/brand";
...
export default function DeskCTA() {
  const phoneHref = `tel:${CHARTER_PHONE_TEL}`;
  const waHref = `https://wa.me/${CHARTER_WHATSAPP}`;
    ...
    >
      <a
        ...
        style={{
          ...
          color: "#ffffff",
          textDecoration: "none",
          boxShadow: "0 8px 28px rgba(2,172,186,0.3)",
          outline: "2px solid rgba(2,172,186,0.55)",
          outlineOffset: "2px",
          lineHeight: 0,
        }}
      >
      ...
      <a
        ...
        aria-label="WhatsApp charter desk"
        title="WhatsApp"
        style={{
          display: "inline-flex",
          alignItems: "center",
